...
import { normalizeOptionalText, validateTenantForm, type TenantFormState } from '@/utils/validation'
...
<template>
  ...
  >
    <form class="tenant-form" @submit.prevent="handleSubmit">
      <div v-if="mode === 'edit' && tenant" class="identity-grid">
        <article class="identity-card">
          <span class="identity-card__label">租户 ID</span>
          <strong>#{{ tenant.id }}</strong>
        </article>
        <article class="identity-card">
          <span class="identity-card__label">当前成员</span>
