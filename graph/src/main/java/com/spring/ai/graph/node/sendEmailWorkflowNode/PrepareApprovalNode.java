...
import com.spring.ai.common.enums.graph.ApprovalStatusEnum;
...
public class PrepareApprovalNode implements NodeAction {
    ...
    public Map<String, Object> apply(OverAllState state) {
        ...
        updates.put(ApprovalWorkflowStateKeys.APPROVAL_STATUS, ApprovalStatusEnum.WAITING_APPROVAL.name());
        return updates;
    }
}
